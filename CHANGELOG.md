...
This changelog is generated by CI/CD; see [CONTRIBUTING.md](CONTRIBUTING.md) for contribution and release guidance.

## [0.6.0](https://github.com/moeakwak/varve/compare/varve-v0.5.0...varve-v0.6.0) (2026-09-25)


### Features

* **cli:** add stable pipeline selectors ([cc9ae21](https://github.com/moeakwak/varve/commit/cc9ae21f6cb99ec52c194d877f65b5d0d4f9bcc0))
* **cli:** support manual branches in default bulk runs ([d95f108](https://github.com/moeakwak/varve/commit/d95f108b8ae48f14181611ea361ba0c52a956e7f))


### Documentation

* group commit details by topic ([c7745e9](https://github.com/moeakwak/varve/commit/c7745e9b576a966ff84fa67365215d543c8a2a24))

## [0.5.0](https://github.com/moeakwak/varve/compare/varve-v0.4.0...varve-v0.5.0) (2026-07-16)


### ⚠ BREAKING CHANGES

* **review:** Dependencies.sources now invalidates automatically; use review_sources when reuse requires review. accept/reject commands are removed in favor of reuse/invalidate, Review Decisions are stored per logical Stage, and existing stores must be rebuilt for schema 6.
* **cli:** generated list is now ls, top-level show is now status MODULE, and refresh is now run --all.
* **core:** KeySpec, key=, uses=, auto_uses=, and Pipeline.auto_uses_packages are removed. Existing stores must be rebuilt with schema 5.

### Features

* **cli:** render status-aware plan topology ([fe842ff](https://github.com/moeakwak/varve/commit/fe842ff51bf68156a75785f1eadafe16d51f78bf))
* **cli:** unify generated and top-level commands ([c90975d](https://github.com/moeakwak/varve/commit/c90975d76338dd30c25024b030e874be4f275781))
* **core:** remove auto uses and add explicit stage dependency declarations ([0ab38be](https://github.com/moeakwak/varve/commit/0ab38be5bd115de22013324b89e433204a7392ac))
* **engine:** unify stage selection and source review state ([2c63cb8](https://github.com/moeakwak/varve/commit/2c63cb85dc5c6a31b9fb85ab56d67b3ab7f8e083))
* **review:** simplify source invalidation and stage review ([ea5c71c](https://github.com/moeakwak/varve/commit/ea5c71c6aeffafb65518a46683f63be57786e053))


### Bug Fixes

* **cli:** hide package main module suffix ([0a5f592](https://github.com/moeakwak/varve/commit/0a5f5920baf027624be7af8604a0c245055363f0))
* **review:** stabilize stage-level source evaluation ([7262680](https://github.com/moeakwak/varve/commit/7262680ec1fcdf72df18cae65149b1b1127c83ca))


### Performance Improvements

* **keying:** reuse exact evaluation observations ([a4c4263](https://github.com/moeakwak/varve/commit/a4c42634d02daa051a7be898156420494e4f3a23))
